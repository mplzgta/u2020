...
public final class U2020App extends Application {
    ...
    //to prevent gc, not sure how this is done in reality
    ...
    public void onCreate() {
        ...
        if (BuildConfig.FLAVOR.equals("internal") && BuildConfig.BUILD_TYPE.equals("debug")) {
            u2020Component = DaggerU2020Component.builder()
                    .u2020Module(new DebugU2020Module(this))
                    .dataModule(new DebugDataModule(this))
                    .build();
            uiComponent = DaggerUiComponent.builder()
                    .uiModule(new DebugUiModule()).build();
        } else {
            u2020Component = DaggerU2020Component.builder()
